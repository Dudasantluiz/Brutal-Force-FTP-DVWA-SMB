...
Este projeto simula e documenta ataques de força bruta usando a ferramenta **Medusa** a partir do Kali Linux contra alvos vulneráveis  do Metasploitable 2, com foco na documentação e mitigação.
